...
namespace BlazorPeliculas.Server.Controllers
{
    ...
    public class VotosController : ControllerBase
    {
        ...
        public async Task<ActionResult> Votar(VotoPeliculaDTO votoPeliculaDTO)
        {
            ...
            var votoAtual = await context.VotosPeliculas.FirstOrDefaultAsync(x => x.PeliculaId == votoPeliculaDTO.PeliculaId && x.UsuarioId == usuarioId);

            if (votoAtual is null)
            {
            ...
            {
                votoAtual.FechaVoto = DateTime.Now;
                votoAtual.Voto = votoPeliculaDTO.Voto;
            }
